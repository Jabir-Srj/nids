...
export const mockNetworkTopology = {
    nodes: [
        { id: '192.168.1.1', label: 'Attacker', type: 'attacker', threat_count: 45 },
        { id: '10.0.0.50', label: 'Web Server', type: 'target', threat_count: 23 },
        { id: '10.0.0.100', label: 'Database', type: 'dest', threat_count: 12 },
        { id: '203.0.113.42', label: 'Scanner', type: 'source', threat_count: 34 },
    ],
    edges: [
