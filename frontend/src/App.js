...
function LoadingSpinner() {
    return (_jsx("div", { className: "flex items-center justify-center h-96", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "inline-block", children: _jsxs("div", { className: "relative w-12 h-12", children: [_jsx("div", { className: "absolute inset-0 rounded-full opacity-20 animate-pulse", style: {
                                ...
                                } }), _jsx("div", { className: "absolute inset-1 rounded-full border-3 border-transparent border-t-[#06b6d4] border-r-[#f59e0b] animate-spin", style: { borderTopColor: '#06b6d4', borderRightColor: '#f59e0b' } })] }) }), _jsx("p", { className: "mt-4 font-code text-sm", style: { color: '#cbd5e1' }, children: "Initializing..." })] }) }));
}
function App() {
    ...
    return (_jsxs("div", { className: "flex h-screen bg-cyber-dark text-white overflow-hidden", children: [_jsxs("div", { className: `${sidebarOpen ? 'w-64' : 'w-20'} border-r transition-all duration-300 flex flex-col`, style: {
                    ...
                    backdropFilter: 'blur(10px)',
                }, children: [_jsx("div", { className: "h-16 px-4 flex items-center border-b transition-colors duration-200", style: { borderColor: 'rgba(6, 182, 212, 0.2)' }, children: _jsxs("div", { className: "flex items-center gap-3 w-full", children: [_jsx("div", { className: "flex items-center justify-center w-10 h-10 text-white rounded-lg", style: {
                                        backgroundColor: 'rgba(6, 182, 212, 0.2)',
                                        boxShadow: '0 0 20px rgba(6, 182, 212, 0.3)',
                                    }, children: _jsx(Shield, { size: 20, className: "font-bold" }) }), sidebarOpen && (_jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "font-bold text-base text-cyan-400 glow", children: "NIDS v3.0" }), _jsx("p", { className: "text-xs truncate font-mono", style: { color: '#cbd5e1' }, children: "Network Guard" })] }))] }) }), _jsx("nav", { className: "flex-1 p-2 space-y-1 overflow-y-auto", children: menuItems.map((item) => (_jsxs("button", { onClick: () => setCurrentPage(item.id), className: `w-full group relative flex items-center gap-3 px-3 py-2.5 rounded-md transition-all duration-200`, style: {
                                backgroundColor: currentPage === item.id
                                    ? 'rgba(6, 182, 212, 0.2)'
                                    : 'transparent',
                                color: currentPage === item.id ? '#06b6d4' : '#cbd5e1',
                            }, title: item.label, children: [_jsx("span", { className: "text-lg flex-shrink-0", children: item.icon }), sidebarOpen && (_jsx("div", { className: "flex-1 text-left min-w-0", children: _jsx("span", { className: "text-sm truncate", children: item.label }) })), sidebarOpen && item.hasCount && alertCount > 0 && (_jsx("span", { className: "flex-shrink-0 inline-flex items-center justify-center px-2 py-0.5 text-xs font-bold text-white rounded-full animate-pulse-glow", style: { backgroundColor: '#ec4899' }, children: alertCount > 99 ? '99+' : alertCount })), !sidebarOpen && item.hasCount && alertCount > 0 && (_jsx("div", { className: "absolute top-1 right-1 w-2.5 h-2.5 rounded-full animate-pulse-glow", style: { backgroundColor: '#ec4899' } }))] }, item.id))) }), _jsx("div", { className: "p-3 border-t transition-colors duration-200", style: { borderColor: 'rgba(6, 182, 212, 0.2)' }, children: _jsx("button", { onClick: () => setSidebarOpen(!sidebarOpen), className: "w-full flex items-center justify-center p-2 rounded-md transition-all duration-200", style: {
                                color: '#cbd5e1',
                            }, onMouseEnter: (e) => {
                            ...
                            borderColor: 'rgba(6, 182, 212, 0.2)',
                            backdropFilter: 'blur(10px)',
                        }, children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: "text-2xl", children: currentMenuItem?.icon }), _jsxs("div", { children: [_jsx("h1", { className: "text-lg font-bold text-cyan-400", children: currentMenuItem?.label }), _jsx("p", { className: "text-xs font-mono", style: { color: '#cbd5e1' }, children: "Real-time Network Intrusion Detection" })] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-md border", style: {
                                            backgroundColor: 'rgba(6, 182, 212, 0.1)',
                                            borderColor: 'rgba(6, 182, 212, 0.3)',
                                        }, children: [_jsx("div", { className: "w-2 h-2 rounded-full animate-pulse-glow", style: { backgroundColor: '#06b6d4' } }), _jsx("span", { className: "text-sm font-semibold font-mono", style: { color: '#06b6d4' }, children: "Online" })] }), _jsxs("button", { className: "p-2 rounded-md transition-all duration-200", style: {
                                            color: '#cbd5e1',
                                        }, onMouseEnter: (e) => {
                                            e.currentTarget.style.backgroundColor = 'rgba(6, 182, 212, 0.1)';
                                            e.currentTarget.style.color = '#06b6d4';
                                            ...
                                            e.currentTarget.style.backgroundColor = 'transparent';
                                            e.currentTarget.style.color = '#cbd5e1';
                                        }, children: [_jsx(Bell, { size: 18 }), alertCount > 0 && (_jsx("div", { className: "absolute top-5 right-14 w-2 h-2 rounded-full animate-pulse-glow", style: { backgroundColor: '#ec4899' } }))] }), _jsxs("div", { className: "relative", children: [_jsx("button", { onClick: () => setShowUserMenu(!showUserMenu), className: "p-2 rounded-md transition-all duration-200", style: {
                                                    color: '#cbd5e1',
                                                }, onMouseEnter: (e) => {
                                                    e.currentTarget.style.backgroundColor = 'rgba(6, 182, 212, 0.1)';
                                                    e.currentTarget.style.color = '#06b6d4';
                                                    ...
                                                    backdropFilter: 'blur(10px)',
                                                            ...
                                                            borderColor: 'rgba(6, 182, 212, 0.2)',
                                                        }, children: [_jsx("p", { className: "text-sm font-semibold text-cyan-400", children: "Jabir" }), _jsx("p", { className: "text-xs font-mono", style: { color: '#cbd5e1' }, children: "Admin" })] }), _jsxs("button", { className: "w-full px-4 py-2 text-sm text-left transition-colors duration-200 flex items-center gap-2", style: {
                                                            color: '#f1f5f9',
                                                        }, onMouseEnter: (e) => {
                                                            e.currentTarget.style.backgroundColor = 'rgba(6, 182, 212, 0.1)';
                                                        }, onMouseLeave: (e) => {
                                                            ...
                                                            e.currentTarget.style.backgroundColor = 'transparent';
                                                        }, children: [_jsx(LogOut, { size: 16 }), "Logout"] })] }))] })] })] }), _jsx("div", { className: "flex-1 overflow-auto p-8", style: { backgroundColor: '#0f172a' }, children: _jsx(ErrorBoundary, { children: _jsx(Suspense, { fallback: _jsx(LoadingSpinner, {}), children: renderContent() }) }) })] })] }));
}
export default App;
